...
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/hyperdown.js?v=' . $suffixVersion;?>"></script>
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/pagedown.js?v=' . $suffixVersion;?>"></script>
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/pagedown-extra.js?v=' . $suffixVersion;?>"></script>
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/diff.js?v=' . $suffixVersion;?>"></script>
<script>
