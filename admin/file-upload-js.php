...
?>
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/moxie.js?v=' . $suffixVersion;?>"></script>
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/plupload.js?v=' . $suffixVersion;?>"></script>
<script>
$(document).ready(function() {
    ...
    $('#tab-files').bind('init', function () {
        var uploader = new plupload.Uploader({
            ...
            flash_swf_url   :   '<?php echo $options->pluginUrl . '/AdminMD/admin_js/Moxie.swf'; ?>',
