...
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/timepicker.js?v=' . $suffixVersion;?>"></script>
<script src="<?php echo $options->pluginUrl . '/AdminMD/admin_js/tokeninput.js?v=' . $suffixVersion;?>"></script>
<script>
