		  ...
		  <h4 class="card-title"><?php include 'page-title.php'; ?></h4>
			...
			<p class="submit clearfix">
				<span class="right">
					...
					<button type="submit" name="do" value="publish" class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-red mdui-text-color-white-text" id="btn-submit"><?php _e('发布文章'); ?></button>
